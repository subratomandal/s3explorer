  ...
  return (
    <div className="fixed inset-0 bg-background flex items-center justify-center p-4">
      ...
      <a
        ...
        className="fixed bottom-4 left-4 w-9 h-9 flex items-center justify-center rounded-full opacity-50 hover:opacity-100 hover:scale-105 transition-all duration-200"
        title="GitHub"
      >
