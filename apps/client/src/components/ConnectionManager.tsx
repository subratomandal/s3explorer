              ...
              {loading ? (
                ...
                connections.map((conn) => (
                  <div
                    ...
                    className={`group relative flex items-center justify-between p-3 rounded-lg bg-background-tertiary border transition-all cursor-pointer overflow-hidden ${
                      conn.isActive ? 'border-accent-purple/50' : 'border-transparent hover:border-accent-purple/30 hover:bg-accent-purple/5'
                    }`}
                  >
                    {/* Left accent border */}
