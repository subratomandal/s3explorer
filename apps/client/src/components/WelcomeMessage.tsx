...
export function WelcomeMessage({ onConfigure }: WelcomeMessageProps) {
  ...
  return (
    ...
    >
      <div className="bg-background-secondary border border-dashed border-border rounded-xl p-4 shadow-xl">
        <button
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0 pr-4">
            ...
            <p className="text-xs text-foreground-muted leading-relaxed mb-3">
              Get started by connecting your S3-compatible storage. It only takes a moment to set up.
            </p>
            <button
              onClick={handleConfigure}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-dashed border-border text-foreground-secondary hover:text-foreground hover:border-border-hover hover:bg-background-hover transition-all text-sm font-medium"
            >
