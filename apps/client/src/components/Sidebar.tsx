            ...
            >
                ...
                <div className="flex-shrink-0 border-t border-border p-3 pb-safe">
                    ...
                    <a
                        ...
                        className="flex items-center gap-2 text-foreground-muted hover:text-foreground transition-colors duration-200 text-xs"
                        aria-label="Visit Subrato Mandal on GitHub (opens in new tab)"
                    >
